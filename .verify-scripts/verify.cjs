...
const BASE = 'http://localhost:5173/NeuralMastery';
...
async function main() {
  ...
  // --- 12. AlgorithmSelector ---
  {
    ...
    const linkOk = href === '/NeuralMastery/docs/machine-learning/linear-regression' || href === '/docs/machine-learning/linear-regression';
