...
description: "GANs and diffusion models -- adversarial training versus iterative denoising, and the real reason diffusion won out for image generation specifically."
---
...
import GanMinimaxDiagram from '../../../viz/diagrams/GanMinimaxDiagram';
...
The forward process's actual closed form, not just the random-walk intuition above — drag $t$ and watch a real noise schedule dissolve a fixed toy signal:
