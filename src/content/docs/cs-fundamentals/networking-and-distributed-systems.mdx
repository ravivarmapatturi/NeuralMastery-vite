...
- **REST**: an architectural convention for structuring HTTP APIs around resources (`/users/123`) and standard verbs (`GET`/`POST`/`PUT`/`DELETE`) — the default style for the model-serving APIs covered in [APIs & Model Serving](/docs/mlops/model-serving).
