...
sidebar_position: 7
description: "Design patterns that actually show up in ML codebases (Strategy, Factory), testing philosophy, profiling, and debugging -- general engineering skill, not ML theory."
---


import DesignPatternDiagram from '../../../viz/diagrams/DesignPatternDiagram';
import TestingPyramidDiagram from '../../../viz/diagrams/TestingPyramidDiagram';
import FlameGraphDiagram from '../../../viz/diagrams/FlameGraphDiagram';
import GitBisectDiagram from '../../../viz/diagrams/GitBisectDiagram';
