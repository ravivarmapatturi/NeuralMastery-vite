...
import __migratedImg0 from './img/spectrogram-demo.png';
...
<img src={__migratedImg0} alt="A synthetic waveform (two steady tones, then a rising chirp) and its spectrogram via STFT" style={{maxWidth: '100%'}} />
