...
Next: [Multi-Armed & Contextual Bandits](/docs/reinforcement-learning/bandits) — the degenerate, single-state special case of everything above, and the actual production answer to the explore/exploit problem this site's recommendation-system material has been gesturing at.
