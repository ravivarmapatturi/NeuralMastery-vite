...
description: "ARIMA, SARIMA, and Prophet -- decomposing a time series into its structural components once shuffling the rows destroys the one thing that matters: order."
---

import __migratedImg0 from './img/time-series-decomposition.png';
import __migratedImg1 from './img/time-series-forecast.png';

import ArimaDifferencingDiagram from '../../../viz/diagrams/ArimaDifferencingDiagram';
...
Real non-stationary series, real differencing applied live:

<ArimaDifferencingDiagram />
