...
import __migratedImg0 from './img/linear-regression-at-a-glance.png';
import __migratedImg1 from './img/linear-regression-scatter-fit.png';
import __migratedImg2 from './img/linear-regression-residuals.png';
...
<img src={__migratedImg0} alt="Linear Regression at a glance — hypothesis, cost, gradient, and update rule" style={{maxWidth: '100%'}} />
...
<img src={__migratedImg1} alt="Study hours vs. exam score, with a fitted regression line" style={{maxWidth: '100%'}} />
...
<img src={__migratedImg2} alt="Residual plot for the study hours vs. exam score fit — scattered randomly around zero" style={{maxWidth: '100%'}} />
