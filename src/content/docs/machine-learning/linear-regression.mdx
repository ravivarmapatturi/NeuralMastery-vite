...
**Try it yourself:** [implement mean squared error from scratch](/practice/mean-squared-error), against real test cases.
...
**Try it yourself:** [implement one gradient descent step from scratch](/practice/gradient-descent-step), against real test cases.
