...
sidebar_position: 3
description: "The general software engineering coding round every AI/ML role still includes -- core DSA patterns to drill: two pointers, sliding window, and more."
---
...
- **Hash maps**: turning an $O(n^2)$ brute-force lookup into $O(n)$ — see [Algorithms & Data Structures](/docs/mathematics-for-ai/algorithms-data-structures) for why this works, made concrete below:
...
Want worked problems for these patterns, not just the strategy? See [Practice Problems](/docs/practice-problems/overview#dsa-coding-interview-patterns) — real problems in each pattern above, with an in-browser sandbox graded against real test cases and a reference-solution reveal.
