...
import __migratedImg0 from './img/convolution-demo.png';
...
<img src={__migratedImg0} alt="A 3x3 Sobel kernel applied to a synthetic image, producing an edge-detected output feature map" style={{maxWidth: '100%'}} />
