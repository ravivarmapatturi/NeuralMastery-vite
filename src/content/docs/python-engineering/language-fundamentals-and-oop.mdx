...
sidebar_position: 3
description: "OOP, decorators, and magic methods explained through the PyTorch code that actually uses them -- nn.Module, Dataset, and why model(x) works at all."
---


import IteratorProtocolDiagram from '../../../viz/diagrams/IteratorProtocolDiagram';
import GeneratorMemoryDiagram from '../../../viz/diagrams/GeneratorMemoryDiagram';
import DecoratorMechanismDiagram from '../../../viz/diagrams/DecoratorMechanismDiagram';
import ContextManagerFlowDiagram from '../../../viz/diagrams/ContextManagerFlowDiagram';
