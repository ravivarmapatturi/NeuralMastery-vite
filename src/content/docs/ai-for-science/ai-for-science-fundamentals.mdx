...
sidebar_position: 3
description: "How ML accelerates science: drug discovery, protein structure prediction, genomics, materials science, physics-informed neural networks, and simulation."
---


import ScreeningFunnelDiagram from '../../../viz/diagrams/ScreeningFunnelDiagram';
import PinnLossDiagram from '../../../viz/diagrams/PinnLossDiagram';
import NeuralOperatorDiagram from '../../../viz/diagrams/NeuralOperatorDiagram';
