...
Next: [Containers](/docs/mlops/containers) — once a pipeline's steps are defined, each step needs to run the same way everywhere, which is what containers solve.
