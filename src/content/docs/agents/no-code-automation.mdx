...
Every agent pattern covered so far — [ReAct loops](/docs/agents/agent-fundamentals), [graphs](/docs/agents/loops-and-graphs), [multi-agent systems](/docs/agents/multi-agent-systems) — is something you write in code. [n8n](https://n8n.io) represents a genuinely different, and genuinely widely-used, way to build the same underlying pattern: a visual workflow canvas instead of a Python file.
