...
description: "The real Reflexion architecture (Shinn et al. 2023): Actor, Evaluator, and Self-Reflection as three distinct models -- verbal feedback in place of retraining."
---
...
Next: [Loops and Graphs](/docs/agents/loops-and-graphs) — the general anatomy both this page and Plan-and-Execute are specific instances of. For the rest of Agent Architectures' patterns (routing, supervisor, memory, durable execution), see [Agent Architectures](/docs/agents/agent-architectures#routing-supervisor-pattern).
