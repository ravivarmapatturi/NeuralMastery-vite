...
sidebar_position: 3
description: "Tokenization, embeddings, positional encoding, KV cache, and attention variants -- the engineering that runs a Transformer efficiently at billions of parameters."
---
...
- **Encoder-only** ([BERT](/docs/deep-learning/bert)-style): sees the full input at once (bidirectional attention) — good for understanding tasks (classification, embeddings), not for generation.
